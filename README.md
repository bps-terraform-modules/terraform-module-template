...
| <a name="input_system_node_pool"></a> [system\_node\_pool](#input\_system\_node\_pool) | Definition for the system node pool | <pre>object({<br/>    vm_size             = optional(string)<br/>    node_count          = optional(number)<br/>    enable_auto_scaling = optional(bool)<br/>    max_count           = optional(number)<br/>    min_count           = optional(number)<br/>    vnet_cidr           = string<br/>  })</pre> | <pre>{<br/>  "enable_auto_scaling": false,<br/>  "max_count": null,<br/>  "min_count": null,<br/>  "node_count": 1,<br/>  "vm_size": "Standard_D2_v2",<br/>  "vnet_cidr": ""<br/>}</pre> | no |
